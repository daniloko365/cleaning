...
export const metadata: Metadata = {
  ...
  title: {
    default: "Novaclean | Orange County Textile Care",
    template: "%s | Novaclean",
  },
  description:
    "Menu-based estimates with photo review for mobile upholstery, mattress, rug and carpet care in Orange County.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Novaclean — clean fabric, clear price",
      },
    ],
  },
